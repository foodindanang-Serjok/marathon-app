  ...
  return arr.map(function(it, i) {
    if (it.type === 'audio') {
      return '<div class="ablock">' +
        ...
        '</div>' +
        '<audio id="medAudio_' + dn + '_' + i + '" controls style="width:100%;margin-top:10px;border-radius:8px;" src="meditation.m4a" ontimeupdate="checkMedStop(this)">' +
